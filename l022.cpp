...
void part2(vector<Point> pts){
    ...
    double max_square=5.0;
    int max_square_index=0;
    ...
    for(int i = 0; i < 6; i++){
        ...
        if(i > 2){
            lines_to_constr[i].push_back(Line());
            lines_to_constr[i].push_back(Line());
        }
    }
    ...
    for(int iter = 0; iter < 3; iter++){
        ...
        Line l1, l2, l3, l4, ll1, ll2, ll3, ll4;
  Point e = Point(lines_to_constr[iter][0].perpendicular(lines_to_constr[iter][1].getA())[1].getB().getx(), lines_to_constr[iter][0].perpendicular(lines_to_constr[iter][1].getA())[1].getB().gety());
        ...
        l1 = Line(lines_to_constr[iter][1].getB().getx(), lines_to_constr[iter][1].getB().gety(), e.getx(), e.gety());

        e = Point(lines_to_constr[iter][0].perpendicular(lines_to_constr[iter][1].getA())[0].getB().getx(), lines_to_constr[iter][0].perpendicular(lines_to_constr[iter][1].getA())[0].getB().gety());
        ll1 = Line(lines_to_constr[iter][1].getB().getx(), lines_to_constr[iter][1].getB().gety(), e.getx(), e.gety());
        lines_to_constr[iter+3].push_back(ll1);
        ...
        l2 = Line(lines_to_constr[iter][1].getA().getx(), lines_to_constr[iter][1].getA().gety(), e.getx(), e.gety());

        e = Point(lines_to_constr[iter][0].perpendicular(lines_to_constr[iter][1].getB())[1].getB().getx(), lines_to_constr[iter][0].perpendicular(lines_to_constr[iter][1].getB())[1].getB().gety());
        ll2 = Line(lines_to_constr[iter][1].getA().getx(), lines_to_constr[iter][1].getA().gety(), e.getx(), e.gety());
        lines_to_constr[iter+3].push_back(ll2);
        ...
        l3 = Line(lines_to_constr[iter][0].getB().getx(), lines_to_constr[iter][0].getB().gety(), e.getx(), e.gety());

        e = Point(lines_to_constr[iter][1].perpendicular(lines_to_constr[iter][0].getA())[1].getB().getx(), lines_to_constr[iter][1].perpendicular(lines_to_constr[iter][0].getA())[1].getB().gety());
        ll3 = Line(lines_to_constr[iter][0].getB().getx(), lines_to_constr[iter][0].getB().gety(), e.getx(), e.gety());
        lines_to_constr[iter+3].push_back(ll3);
        ...
        l4 = Line(lines_to_constr[iter][0].getA().getx(), lines_to_constr[iter][0].getA().gety(), e.getx(), e.gety());

        e = Point(lines_to_constr[iter][1].perpendicular(lines_to_constr[iter][0].getB())[0].getB().getx(), lines_to_constr[iter][1].perpendicular(lines_to_constr[iter][0].getB())[0].getB().gety());
        ll4 = Line(lines_to_constr[iter][0].getA().getx(), lines_to_constr[iter][0].getA().gety(), e.getx(), e.gety());
        lines_to_constr[iter+3].push_back(ll4);

        double dist = Line(l1.intersection(l3).getx(), l1.intersection(l3).gety(), l1.intersection(l4).getx(), l1.intersection(l4).gety()).distance();
        if(dist > max_square){
            max_square = dist;
            max_square_index = iter;
        }
        dist = Line(ll1.intersection(ll3).getx(), ll1.intersection(ll3).gety(), ll1.intersection(ll4).getx(), ll1.intersection(ll4).gety()).distance();
        if(dist < max_square){
            max_square = dist;
            max_square_index = iter+3;
        }
    }
    Canvas p;
    p.drawCircle((int)(ax*SIZE), (int)(ay*SIZE), 3);
    p.drawCircle((int)(bx*SIZE), (int)(by*SIZE), 3);
    p.drawCircle((int)(cx*SIZE), (int)(cy*SIZE), 3);
    p.drawCircle((int)(dx*SIZE), (int)(dy*SIZE), 3);
    for(int i = 2; i < 6; i++){
        p.drawSquare(lines_to_constr[max_square_index][i]);
        cout << (int)(lines_to_constr[max_square_index][i].getA().getx()*SIZE) << endl;
        cout << (int)(lines_to_constr[max_square_index][i].getA().gety()*SIZE) << endl;
        cout << (int)(lines_to_constr[max_square_index][i].getB().getx()*SIZE) << endl;
        cout << (int)(lines_to_constr[max_square_index][i].getB().gety()*SIZE) << endl << endl;
    }
    p.draw_grid();
    ofstream output;
    vector<Line> o = lines_to_constr[max_square_index];
    double v1x, v1y, v2x, v2y, v3x, v3y, v4x, v4y;
    v1x = o[2].intersection(o[4]).getx();
    v1y = o[2].intersection(o[4]).gety();

    v2x = o[2].intersection(o[5]).getx();
    v2y = o[2].intersection(o[5]).gety();

    v3x = o[3].intersection(o[4]).getx();
    v3y = o[3].intersection(o[4]).gety();

    v4x = o[3].intersection(o[5]).getx();
    v4y = o[3].intersection(o[5]).gety();

    p.drawCircle((int)(v1x*SIZE), (int)(v1y*SIZE), 3);
    p.drawCircle((int)(v2x*SIZE), (int)(v2y*SIZE), 3);
    p.drawCircle((int)(v3x*SIZE), (int)(v3y*SIZE), 3);
    p.drawCircle((int)(v4x*SIZE), (int)(v4y*SIZE), 3);
    p.draw_grid();
    output.open("output.txt");
    output << fixed;
    output << setprecision(17);
    output << "(" << ax<<","<<ay<<") , ("<< bx<<","<<by<<") , ("<< cx<<","<<cy<<") , ("<< dx<<","<<dy<<")"<<endl;
    output << "(" << v1x<<","<<v1y<<") , ("<< v2x<<","<<v2y<<") , ("<< v3x<<","<<v3y<<") , ("<< v4x<<","<<v4y<<") Area="<< pow(max_square, 2.0) << endl;
}
